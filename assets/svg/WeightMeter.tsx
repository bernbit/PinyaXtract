...
function WeightMeter({ width = 114, height = 114 }: SVGPropsType) {
  const { weightValue } = useGlobal();
  const pointerRotation = useSharedValue<number>(-74);
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 114 114" fill="none">
      <G clipPath="url(#clip0_350_11)">
        ...
        {/* Pointer         */}
        <Circle cx={55.9768} cy={31.85} r={5.5} fill="#FEFEFE" />
        <Pointer
      ...
      <Defs>
        <ClipPath id="clip0_350_11">
          <Path fill="#FEFEFE" d="M0 0H114V114H0z" />
        </ClipPath>
      </Defs>
    </Svg>
  );
